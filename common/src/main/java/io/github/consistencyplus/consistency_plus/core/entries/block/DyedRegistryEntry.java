...
public class DyedRegistryEntry extends AbstractRegistryEntry {
    static boolean withBase;

    public DyedRegistryEntry(String name, AbstractBlock.Settings blockSettings, Boolean withBase) {
        super(name, blockSettings, false);
        DyedRegistryEntry.withBase = withBase;
        construct();
    }
        ...
        for (DyeColor color : DyeColor.values()) {
            for (BlockTypes type : BlockTypes.values()) {
                for (BlockShapes shape : BlockShapes.values()) {
                    ...
                    AbstractBlock.Settings dyedBlockSettings = (name.equals("terracotta")) ? blockSettings.mapColor(CPlusEnhancedRegistry.toTerracottaMapColor(color)) : blockSettings.mapColor(color.getMapColor());
