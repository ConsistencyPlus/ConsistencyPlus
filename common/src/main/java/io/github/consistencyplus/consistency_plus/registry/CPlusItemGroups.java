...
public class CPlusItemGroups {
	public static final ItemGroup CONSISTENCY_PLUS_STONES = CreativeTabs.create(ConsistencyPlusMain.id("stone"), () -> new ItemStack(CPlusItems.POLISHED_STONE));
	public static final ItemGroup CONSISTENCY_PLUS_DYEABLES = CreativeTabs.create(ConsistencyPlusMain.id("dyeable"), () -> new ItemStack(CPlusItems.TERRACOTTA_STAIRS));
	public static final ItemGroup CONSISTENCY_PLUS_MISC = CreativeTabs.create(ConsistencyPlusMain.id("misc"), () -> new ItemStack(CPlusItems.PURPUR_BLOCK));
