...
//Purpur
	...
	public static final Block PURPUR_TILE_WALL = register("purpur_tile_wall", new WallBlock(FabricBlockSettings.copy(Blocks.PURPUR_BLOCK)));
	public static final Block PURPUR_TILE_GATE = register("purpur_tile_gate", new FenceGateBlock(FabricBlockSettings.copy(Blocks.PURPUR_BLOCK)));
